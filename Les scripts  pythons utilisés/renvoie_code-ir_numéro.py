...
def main():
    ...
    print("Waiting 2 seconds for IR signals.  A list of all received commands will be returned.")
    sleep(2)
    ...
    print("Waiting 2 seconds for IR signals.  The last received command will be returned.")
    sleep(2)
